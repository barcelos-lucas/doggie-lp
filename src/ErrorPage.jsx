...
export default function ErrorPage({ code }) {
  ...
  return <main className="error-page">
    ...
    <section className="error-card">
      ...
      <div className="error-actions">{missing ? <><a className="button cookie-primary" href="/"><House size={19} aria-hidden="true" />Voltar ao início</a><a className="button cookie-secondary" href={whatsappUrl()} target="_blank" rel="noopener noreferrer"><WhatsappLogo size={19} aria-hidden="true" />Falar com a Doggie</a></> : <><button type="button" className="button cookie-primary" onClick={() => window.location.reload()}><ArrowClockwise size={19} aria-hidden="true" />Tentar novamente</button><a className="button cookie-secondary" href={whatsappUrl()} target="_blank" rel="noopener noreferrer"><WhatsappLogo size={19} aria-hidden="true" />Falar com a Tia Bia</a><a className="error-home-link" href="/"><House size={16} aria-hidden="true" />Voltar ao início</a></>}</div>
