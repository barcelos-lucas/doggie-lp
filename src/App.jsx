...
export default function App({ initialPath }) {
  ...
  return <>
    ...
    <footer className="footer"><div className="footer-paw-trail" aria-hidden="true">{Array.from({ length: 7 }, (_, index) => <PawPrint key={index} size={19} weight="fill" style={{ "--step": index }} />)}</div><div className="container"><div className="footer-main">
