...
export default function MapPanel() {
  ...
  return <div className="map-panel">
    {showMap ? <iframe title="Mapa da Doggie em Assunção, São Bernardo do Campo" src="https://www.google.com/maps?q=R.%20Heitor%20de%20Souza%2C%20190%2C%20Assun%C3%A7%C3%A3o%2C%20S%C3%A3o%20Bernardo%20do%20Campo&z=16&output=embed" referrerPolicy="no-referrer-when-downgrade" /> : <div className="map-invitation"><MapPin size={42} weight="light" aria-hidden="true" /><span>Encontre a Doggie no</span><strong>Assunção.</strong><p>São Bernardo do Campo, SP</p><button type="button" className="button outline" onClick={() => setShowMap(true)}>Carregar mapa</button></div>}
